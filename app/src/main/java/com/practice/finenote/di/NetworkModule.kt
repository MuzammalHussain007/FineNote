...
//    @Singleton
//    @Provides
//    fun  manageServiceNote(retrofit: Retrofit.Builder,@ApplicationContext context: Context,authenticationInterceptor: AuthenticationInterceptor) : NoteAPI {
//        return retrofit.
//        client(getHttpClient(context).addInterceptor(authenticationInterceptor).build())
//            .build()
