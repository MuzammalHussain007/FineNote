...
import com.practice.finenote.modals.noteModalResponse.GetNoteModal
...
class NoteRepositry @Inject constructor(private val noteAPI: NoteAPI) {
    ...
    private val _noteResponseMuteableLivedata = MutableLiveData<ErrorHandling<List<GetNoteResponse>>>()
    ...
    suspend fun getNotes() {
        ...
        if (response.isSuccessful && response.body() != null) {
            _noteResponseMuteableLivedata.postValue(ErrorHandling.Success(response.body()!!))
